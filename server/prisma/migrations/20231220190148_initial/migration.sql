...
CREATE TABLE "BlockListItem" (
    ...
    CONSTRAINT "BlockListItem_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "BlockListItem" ADD CONSTRAINT "BlockListItem_blockListId_fkey" FOREIGN KEY ("blockListId") REFERENCES "BlockList"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
